...
fusiontype = 'MeanMax';   % Fusion rule (e.g., MeanMax, MaxMin, etc
wavetype   = 'coif5';     % Wavelet type
...
% Perform channel-wise fusion for RGB images
...
% Save fused image
imwrite(imresize(fusedimage, [row, col]), ...
'fusedimage.jpg', 'Quality', 100);
